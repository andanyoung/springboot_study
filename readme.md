...
课程所有源码提供免费下载：[下载地址](https://github.com/AndyYoungCN/springboot_study)。
...
课程源代码下载地址：[戳我下载](https://github.com/AndyYoungCN/springboot_study)
...
public class SwaggerConfig {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                // 设置接口描述
                .description("一起学Spring Boot第06课")
                // 设置联系方式
...
这个统一的 json 结构这可以参考[第02课：Spring Boot 返回 JSON 数据及数据封装]中封装的统一 json 结构，本节内容我们简化一下，只保留状态码 code 和异常信息 msg即可。如下：
```java
...
public class SwaggerConfig {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                // 设置接口描述
                .description("一起学Spring Boot第18课")
                // 设置联系方式
